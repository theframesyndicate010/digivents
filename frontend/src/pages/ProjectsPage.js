  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-10 py-20">
        ...
        {/* Project Grid - Two Columns (Videos & Graphics) */}
        <main>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div>
                  ...
                  >
                    ...
                    {!loading && filteredProjects.filter(p => p.videoUrl).length === 0 && (
                      <div className="text-center py-12">
                        <p className="text-white/40 text-sm">No video projects</p>
                      </div>
                    )}
                  </motion.div>
                </div>
                ...
                <div>
                  ...
                  >
                    ...
                    {!loading && filteredProjects.filter(p => !p.videoUrl).length === 0 && (
                      <div className="text-center py-12">
                        <p className="text-white/40 text-sm">No graphic projects</p>
                      </div>
                    )}
                  </motion.div>
                </div>
